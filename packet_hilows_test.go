...
func TestHiLowsFromPacket(t *testing.T) {
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 18, 20, 0, 0,
		time.Now().Location()), hl.Bar.Day.LowTime, "Dew point day low time")
	a.Equal(30.177, hl.Bar.Day.Hi, "Barometer day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 10, 20, 0, 0,
		time.Now().Location()), hl.Bar.Day.HiTime, "Dew point day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 4, 6, 0, 0,
		time.Now().Location()), hl.DewPoint.Day.LowTime, "Dew point day low time")
	a.Equal(73.0, hl.DewPoint.Day.Hi, "Dew point day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 0, 15, 0, 0,
		time.Now().Location()), hl.DewPoint.Day.HiTime, "Dew point day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 13, 32, 0, 0,
		time.Now().Location()), hl.HeatIndex.Day.HiTime, "Heat index day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 0, 49, 0, 0,
		time.Now().Location()), hl.InHumidity.Day.LowTime, "Inside humidity day low time")
	a.Equal(43, hl.InHumidity.Day.Hi, "Inside humidity day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 6, 36, 0, 0,
		time.Now().Location()), hl.InHumidity.Day.HiTime, "Inside humidity day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 9, 42, 0, 0,
		time.Now().Location()), hl.InTemp.Day.LowTime, "Inside temperature day low time")
	a.Equal(80.0, hl.InTemp.Day.Hi, "Inside temperature day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 0, 12, 0, 0,
		time.Now().Location()), hl.InTemp.Day.HiTime, "Inside temperature day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 13, 39, 0, 0,
		time.Now().Location()), hl.OutHumidity.Day.LowTime, "Outside humidity day low time")
	a.Equal(83, hl.OutHumidity.Day.Hi, "Outside humidity day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 0, 5, 0, 0,
		time.Now().Location()), hl.OutHumidity.Day.HiTime, "Outside humidity day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 5, 10, 0, 0,
		time.Now().Location()), hl.OutTemp.Day.LowTime, "Outside temperature day low time")
	a.Equal(88.9, hl.OutTemp.Day.Hi, "Outside temperature day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 13, 34, 0, 0,
		time.Now().Location()), hl.OutTemp.Day.HiTime, "Outside temperature day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 0, 0, 0, 0,
		time.Now().Location()), hl.SoilMoist[0].Day.LowTime, "Soil moisture day low time")
	a.Equal(29, hl.SoilMoist[0].Day.Hi, "Soil moisture day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 17, 40, 0, 0,
		time.Now().Location()), hl.SoilMoist[0].Day.HiTime, "Soil moisture day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 7, 53, 0, 0,
		time.Now().Location()), hl.SoilTemp[0].Day.LowTime, "Soil temperature day low time")
	a.Equal(83, hl.SoilTemp[0].Day.Hi, "Soil temperature day high")
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 16, 16, 0, 0,
		time.Now().Location()), hl.SoilTemp[0].Day.HiTime, "Soil temperature day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 13, 13, 0, 0,
		time.Now().Location()), hl.SolarRad.Day.HiTime, "Solar radiation day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 14, 22, 0, 0,
		time.Now().Location()), hl.THSWIndex.Day.HiTime, "THSW index day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 12, 59, 0, 0,
		time.Now().Location()), hl.UVIndex.Day.HiTime, "UltraViolet index day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 1, 41, 0, 0,
		time.Now().Location()), hl.WindSpeed.Day.HiTime, "Wind speed day high time")
	...
	a.Equal(time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), 4, 58, 0, 0,
		time.Now().Location()), hl.WindChill.Day.LowTime, "Wind chill day low time")
